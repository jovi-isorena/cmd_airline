        ...
        <form action="register" method="post">
            ...
            <div class="form-row">
                <div class="form-group col">
                    ...
                    <span style="color: red;">* <?php echo $data['positionError'];?></span>
                    <select class="custom-select" name="position">
                        <option value= "0" <?php if($data['position'] == 0) echo 'selected';?>>Select One</option>
                        <option value="1" <?php if($data['position'] == 1) echo 'selected';?>>ADMIN</option>
                        <option value="2" <?php if($data['position'] == 2) echo 'selected';?>>FLIGHT OPERATOR</option>
                        <option value="3" <?php if($data['position'] == 3) echo 'selected';?>>FLIGHT ASSISTANT</option>
                    </select>
                </div>
